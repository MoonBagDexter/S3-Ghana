  ...
  "questions": [
    {
      ...
      "explanations": {
        "A": "Incorrect. Maximal growth velocity does not precede breast development; thelarche is the first outward sign of puberty in most girls, and menarche occurs late, not second.",
        "B": "Incorrect. Puberty does not begin with maximal growth velocity; breast budding (thelarche) precedes the growth spurt.",
        "C": "Incorrect. Menarche is one of the last events of puberty, not the first, and thelarche does not come last.",
    ...
    },
    {
      ...
      "answerSource": "circled",
      "explanations": {
        "A": "Incorrect. Chronic illness causes hypogonadotropic hypogonadism (suppressed hypothalamic-pituitary drive), so FSH/LH are low, not elevated.",
        "B": "Correct. Gonadal dysgenesis (e.g., Turner syndrome) is primary gonadal (ovarian) failure; with no ovarian estrogen there is loss of negative feedback, so FSH and LH are markedly ELEVATED (hypergonadotropic hypogonadism).",
        "C": "Incorrect. Hypothalamic tumors impair GnRH secretion, producing low gonadotropins (hypogonadotropic hypogonadism).",
    ...
    },
    {
      ...
      "answerSource": "circled",
      "explanations": {
        "A": "Incorrect. A unicornuate uterus is a congenital Mullerian anomaly; it would not be caused by prior curettage and does not fit the acquired history described.",
        "B": "Incorrect. Distal tubal obstruction (often from PID/salpingitis) is unrelated to repeated D&C and would not explain recurrent early miscarriage.",
        "C": "Incorrect. Proximal tubal obstruction causes infertility but is not a consequence of intrauterine curettage and does not cause recurrent pregnancy loss.",
    ...
    },
    {
      ...
      "answerSource": "circled",
      "explanations": {
        "A": "Correct. A granulosa cell tumor is an estrogen-secreting sex cord-stromal tumor; unopposed estrogen in a postmenopausal woman causes endometrial hyperplasia and adenocarcinoma, exactly the combination of an adnexal mass plus endometrial cancer and bleeding described here.",
        "B": "Incorrect. Sertoli-Leydig cell tumors secrete androgens and produce virilization/defeminization, not the estrogenic endometrial adenocarcinoma seen in this patient.",
        "C": "Incorrect. Immature teratoma is a malignant germ cell tumor of young women (first two decades) and is not hormonally active in a way that produces endometrial adenocarcinoma.",
    ...
    },
    {
      ...
      "answerSource": "circled",
      "explanations": {
        "A": "Incorrect. Granulosa cell tumors show Call-Exner bodies and coffee-bean nuclei, not signet-ring cells, and are usually unilateral.",
    ...
    },
    {
      ...
      "answerSource": "circled",
      "explanations": {
        "A": "Incorrect. The bleeding is light and already diminishing, which is expected early adjustment; discontinuing the method is unnecessary and would deprive her of effective contraception.",
        "B": "Correct. Light, irregular (breakthrough) bleeding in the first few months of starting COCs is common and typically resolves as the endometrium adjusts; the appropriate management is counseling and reassurance with continued use.",
    ...
    },
    {
      ...
      "answerSource": "circled",
      "explanations": {
        "A": "Cervical dilation addresses outflow obstruction at the cervix (cervical stenosis) but will not lyse the intrauterine synechiae that are the pathology here, so it is not the definitive treatment.",
        "B": "Correct. The picture is Asherman syndrome (intrauterine adhesions after D&C for septic abortion). Hysteroscopic adhesiolysis via operative hysteroscopy allows direct visualization and division of the adhesions and is the treatment of choice.",
    ...
    },
    {
      ...
      "answerSource": "circled",
      "explanations": {
        "A": "Pelvic congestion syndrome causes chronic dull pelvic pain from pelvic varicosities but does not produce uterosacral nodularity, progressive dysmenorrhea, or an ovarian cyst with infertility.",
        "B": "Correct. Progressive secondary dysmenorrhea, infertility, tender nodular uterosacral ligaments and a 5 cm ovarian cyst (endometrioma) are the classic picture of pelvic endometriosis.",
