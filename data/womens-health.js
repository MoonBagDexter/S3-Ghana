...
window.QUIZ_DECKS.push(
{
  ...
  "questions": [
    {
      "num": 1,
      "question": "What is the fertilizable lifespan of the human sperm?",
      "options": [
        {
          "key": "A",
          "text": "6–8 hours"
      ...
      "explanations": {
        "C": "Correct. Once in the female reproductive tract, sperm retain the ability to fertilize an oocyte for about 48–72 hours (though some survive longer). This is the standard figure paired with the ~12–24 hour fertilizable lifespan of the ovum.",
        "A": "Incorrect. 6–8 hours is far too short; this underestimates sperm survival in cervical mucus.",
    ...
    {
      "num": 2,
      "question": "Which of the following is the correct sequence of events during implantation?",
      "options": [
        {
          "key": "A",
          "text": "Hatching → Adhesion → Invasion → Decidualization"
        },
        {
          "key": "B",
          "text": "Adhesion → Hatching → Invasion → Decidualization"
        },
        {
          "key": "C",
          "text": "Decidualization → Hatching → Adhesion → Invasion"
        },
        {
          "key": "D",
          "text": "Hatching → Invasion → Adhesion → Decidualization"
        }
      ],
      "correct": "A",
      "answerSource": "inferred",
      "explanations": {
        "A": "Correct. The blastocyst first hatches from the zona pellucida, then apposes/adheres to the endometrium, then the trophoblast invades, and the surrounding stroma undergoes decidualization.",
        "B": "Incorrect. Adhesion cannot precede hatching — the blastocyst must escape the zona pellucida first.",
    ...
    {
      "num": 3,
      "question": "What is the primary risk associated with smoking during pregnancy?",
      "options": [
        {
          "key": "A",
          "text": "Increased risk of miscarriage and IUGR"
        },
        {
          "key": "B",
        ...
        {
          "key": "C",
          "text": "Increased risk of preeclampsia"
        },
        {
          "key": "D",
          "text": "Increased risk of venous thromboembolism"
        }
      ],
      "correct": "A",
      "answerSource": "inferred",
      "explanations": {
        "A": "Correct. Carbon monoxide and nicotine reduce uteroplacental perfusion and oxygen delivery, producing intrauterine growth restriction, and smoking raises the risk of miscarriage, abruption, preterm birth and stillbirth.",
        "B": "Incorrect. Smoking is not a recognised risk factor for gestational diabetes.",
    ...
    {
      "num": 4,
      "question": "What is the primary mechanism by which progesterone affects respiratory function during pregnancy?",
      "options": [
        {
          "key": "A",
          "text": "It increases tidal volume"
        },
        {
          "key": "B",
          "text": "It acts on the respiratory center to increase sensitivity to CO2"
        },
        {
          "key": "C",
          "text": "It decreases functional residual capacity"
        },
        {
          "key": "D",
          "text": "It elevates the diaphragm"
        }
      ],
      "correct": "B",
      "answerSource": "inferred",
      "explanations": {
        "B": "Correct. Progesterone sensitizes the central respiratory centre to CO2, driving the increase in minute ventilation and the mild compensated respiratory alkalosis of pregnancy.",
        "A": "Incorrect. Increased tidal volume is the RESULT of the heightened respiratory drive, not the mechanism itself.",
    ...
    {
      "num": 5,
      "question": "Which of the following antiepileptic drugs have the highest risk of congenital anomalies?",
      "options": [
        {
          "key": "A",
      ...
      "answerSource": "inferred",
      "explanations": {
        "A": "Correct. Sodium valproate carries the highest teratogenic risk of the common antiepileptics — neural tube defects, cardiac and craniofacial anomalies, and dose-related neurodevelopmental impairment — and is avoided in women of childbearing potential.",
        "B": "Incorrect. Lamotrigine is one of the SAFER antiepileptics in pregnancy, with comparatively low malformation rates.",
    ...
    {
      "num": 6,
      "question": "Which is the most common cause of hyperthyroidism in pregnancy?",
      "options": [
        {
          "key": "A",
          "text": "Toxic multinodular goitre"
        },
        {
          "key": "B",
        ...
        {
          "key": "D",
          "text": "Gestational transient hyperthyroidism"
        }
      ],
      "correct": "C",
      "answerSource": "inferred",
      "explanations": {
        "C": "Correct. Graves' disease is the most common cause of true (autoimmune) hyperthyroidism in pregnancy, caused by TSH-receptor stimulating antibodies. Note: if transient/biochemical cases are counted, gestational transient hyperthyroidism (option D, hCG-mediated) is the most common cause overall — confirm which definition your course uses.",
        "A": "Incorrect. Toxic multinodular goitre is an uncommon cause in the reproductive age group.",
    ...
    {
      "num": 7,
      "question": "At which gestational age should a pregnant woman with well controlled gestational diabetes be delivered?",
      "options": [
        {
          "key": "A",
          "text": "39–40+6 weeks gestation"
        },
        {
          "key": "B",
          "text": "37–38+6 weeks gestation"
        },
        {
          "key": "C",
          "text": "36–37+6 weeks gestation"
        },
        {
          "key": "D",
          "text": "35–36+6 weeks gestation"
        }
      ],
      "correct": "A",
      "answerSource": "inferred",
      "explanations": {
        "A": "Correct. For gestational diabetes that is well controlled (diet-controlled, no fetal or maternal complications), delivery is advised around 39–40+6 weeks — no later than 40+6 (NICE).",
        "B": "Incorrect. 37–38+6 weeks is reserved for less well controlled diabetes or where complications exist.",
    ...
    {
      "num": 8,
      "question": "When is the dating scan and first trimester screening tests best performed?",
      "options": [
        {
          "key": "A",
          "text": "9 and 11 weeks gestation"
        },
        {
          "key": "B",
          "text": "11 and 13 weeks gestation"
        },
        {
          "key": "C",
          "text": "13 and 15 weeks gestation"
        },
        {
          "key": "D",
          "text": "15 and 17 weeks gestation"
        }
      ],
      "correct": "B",
      "answerSource": "inferred",
      "explanations": {
        "B": "Correct. The combined test / dating scan (including nuchal translucency) is performed between 11+0 and 13+6 weeks, when the crown–rump length is 45–84 mm.",
        "A": "Incorrect. 9–11 weeks is too early — the NT measurement and CRL window are not yet reliable.",
    ...
    {
      "num": 9,
      "question": "Which maternal factor carries a high risk of preeclampsia?",
      "options": [
        {
          "key": "A",
        ...
        {
          "key": "C",
          "text": "Family history of preeclampsia"
        },
        {
          "key": "D",
          "text": "Previous history of preeclampsia"
        }
      ],
      "correct": "D",
      "answerSource": "inferred",
      "explanations": {
        "D": "Correct. A previous history of pre-eclampsia (or previous hypertensive disease in pregnancy) is a HIGH-risk factor warranting aspirin prophylaxis on its own.",
        "A": "Incorrect. Multiple pregnancy is a MODERATE-risk factor.",
    ...
    },
    {
      ...
      "answerSource": "inferred",
      "explanations": {
        "A": "Correct. An isolated rise in AFP with normal hCG, oestriol and inhibin A points to an open neural tube defect (or another open fetal defect), where AFP leaks into the amniotic fluid and maternal circulation.",
        "B": "Incorrect. Trisomy 18 characteristically produces LOW AFP, hCG and oestriol.",
    ...
    {
      "num": 11,
      "question": "Which of the following is a non-invasive prenatal test (NIPT)?",
      "options": [
        {
          "key": "A",
        ...
        {
          "key": "B",
          "text": "Cell free fetal DNA testing"
        },
        {
          "key": "C",
          "text": "Amniocentesis"
      ...
      "answerSource": "inferred",
      "explanations": {
        "B": "Correct. NIPT analyses cell-free fetal DNA from a maternal blood sample, carrying no procedure-related risk to the pregnancy.",
        "A": "Incorrect. Chorionic villus sampling is invasive and carries a miscarriage risk.",
    ...
    {
      "num": 12,
      "question": "Which of the following is used to detect structural fetal abnormalities most effectively?",
      "options": [
        {
          "key": "A",
          "text": "Quadruple test"
        ...
        {
          "key": "C",
          "text": "Level II ultrasound (fetal anomaly scan)"
        },
        {
          "key": "D",
          "text": "PAPP-A test"
      ...
      "answerSource": "inferred",
      "explanations": {
        "C": "Correct. The Level II (detailed anatomy / fetal anomaly) ultrasound at 18–20+6 weeks is the test that directly visualises and detects structural malformations.",
        "A": "Incorrect. The quadruple test is a biochemical screen for aneuploidy and open NTDs, not a structural assessment.",
    ...
    {
      "num": 13,
      "question": "Which of the following is a common presentation of missed miscarriage?",
      "options": [
        {
          "key": "A",
          "text": "Severe colicky pain."
        },
        {
          "key": "B",
          "text": "Heavy vaginal bleeding with blood clots."
        },
        {
          "key": "C",
          "text": "Passage of conceptus tissue."
        },
        {
          "key": "D",
          "text": "No symptoms or minimal spotting."
        }
      ],
      "correct": "D",
      "answerSource": "inferred",
      "explanations": {
        "D": "Correct. A missed miscarriage is typically silent — the fetus has died but is retained, so the woman is often asymptomatic or has only minor spotting, and it is frequently discovered incidentally on ultrasound.",
        "A": "Incorrect. Severe colicky pain suggests an inevitable or incomplete miscarriage with cervical dilatation.",
    ...
    {
      "num": 14,
      "question": "A 30-year-old G2P1 woman at 7-week gestation presents with sudden onset of sharp, unilateral lower abdominal pain and light vaginal spotting. Her vital signs are: BP 100/60 mm Hg and heart rate 110 bpm. On examination she has right adnexal tenderness and closed cervical os. Serum b-hCG is 1200 mIU/ml. Transvaginal ultrasound shows no intrauterine gestational sac with a 2 cm right adnexal mass. What is the most appropriate next step?",
      "options": [
        {
          "key": "A",
          "text": "Expectant management with repeat B-hCG in one week."
        },
        {
          "key": "B",
        ...
        {
          "key": "C",
          "text": "Urgent diagnostic laparoscopy"
        },
        {
          "key": "D",
          "text": "Uterine curettage"
        }
      ],
      "correct": "C",
      "answerSource": "inferred",
      "explanations": {
        "C": "Correct. This is a symptomatic ectopic pregnancy with an adnexal mass and signs of haemodynamic compromise (tachycardia, borderline BP, acute sharp pain suggesting possible rupture). Urgent diagnostic laparoscopy is both diagnostic and therapeutic and is the safe choice when the patient is not clearly stable.",
        "A": "Incorrect. Expectant management needs an asymptomatic, stable patient with low and falling hCG — she is symptomatic and tachycardic.",
    ...
    {
      "num": 15,
      "question": "Which of the following is a characteristic of complete molar pregnancy?",
      "options": [
        {
          "key": "A",
          "text": "Serum b-hCG levels are usually low"
        },
        {
          "key": "B",
          "text": "Arises from fertilization of an empty ovum by one sperm that duplicates its DNA."
        },
        {
          "key": "C",
          "text": "Presence of fetal tissue"
        },
        {
          "key": "D",
          "text": "Associated with 69XXY karyotype"
        }
      ],
      "correct": "B",
      "answerSource": "inferred",
      "explanations": {
        "B": "Correct. A complete mole arises when an empty ovum (no maternal DNA) is fertilized by one sperm that duplicates (46,XX) or by two sperm; all genetic material is paternal and no fetal tissue forms.",
        "A": "Incorrect. β-hCG is characteristically VERY HIGH in a complete mole, not low.",
    ...
    {
      "num": 16,
      "question": "Which of the following is NOT a characteristic feature of the endometrium in a normal menstrual cycle?",
      "options": [
        {
          "key": "A",
          "text": "Appearance of highly coiled endometrial glands is under the influence of progesterone"
        },
        {
          "key": "B",
          "text": "Subnuclear vacuoles are seen in endometrial cells before ovulation."
        },
        {
          "key": "C",
          "text": "The superficial layer of the endometrium consists of stratum compactum and stratum spongiosum."
        },
        {
          "key": "D",
          "text": "Triple line sign of the endometrium on ultrasound is characteristic of periovulation"
        }
      ],
      "correct": "B",
      "answerSource": "inferred",
      "explanations": {
        "B": "Correct. This is the incorrect statement. Subnuclear (basal) vacuoles are the earliest histological evidence of ovulation and appear AFTER ovulation, in the early secretory phase (around days 16–17) — not before it.",
        "A": "Incorrect. True — progesterone in the secretory phase produces coiled, tortuous glands.",
    ...
    {
      "num": 17,
      "question": "What is the oestradiol concentration and duration needed to initiate a luteinizing hormone surge?",
      "options": [
        {
          "key": "A",
          "text": "50 pg/ml for 48 hrs"
        },
        {
          "key": "B",
          "text": "100 pg/ml for 12 hrs"
        },
        {
          "key": "C",
          "text": "200 pg/ml for 24 hrs"
        },
        {
          "key": "D",
          "text": "200 pg/ml for 50 hrs"
        }
      ],
      "correct": "D",
      "answerSource": "inferred",
      "explanations": {
        "D": "Correct. Positive feedback triggering the LH surge requires a sustained oestradiol concentration of roughly ≥200 pg/ml maintained for about 50 hours.",
        "A": "Incorrect. 50 pg/ml is below the threshold and would exert negative, not positive, feedback.",
    ...
    {
      "num": 18,
      "question": "Which of the following best describes the two-cell theory of ovarian steroidogenesis?",
      "options": [
        {
          "key": "A",
          "text": "LH stimulates theca cells to produce oestradiol."
        },
        {
          "key": "B",
          "text": "FSH stimulates granulosa cells to secrete androstenedione"
        },
        {
          "key": "C",
          "text": "It describes the action of FSH and LH on granulosa and theca cells respectively."
        },
        {
          "key": "D",
          "text": "It describes the action of FSH and LH on theca cells and granulosa cells respectively."
        }
      ],
      "correct": "C",
      "answerSource": "inferred",
      "explanations": {
        "C": "Correct. In the two-cell, two-gonadotropin model, FSH acts on granulosa cells and LH acts on theca cells — i.e. FSH and LH act on granulosa and theca cells respectively. LH drives thecal androgen production; FSH drives granulosa aromatization of those androgens to oestradiol.",
        "A": "Incorrect. Theca cells produce androgens (androstenedione) under LH, not oestradiol.",
    ...
    {
      "num": 19,
      "question": "Which of the following is predictive of heavy menstrual bleeding?",
      "options": [
        {
          "key": "A",
          "text": "Clots ≥ 1 cm in diameter"
        },
        {
          "key": "B",
          "text": "Flooding"
        ...
        {
          "key": "C",
          "text": "Change of pad or tampon every 4 hours"
        },
        {
          "key": "D",
          "text": "Low ferritin levels"
        }
      ],
      "correct": "D",
      "answerSource": "inferred",
      "explanations": {
        "D": "Correct. Low ferritin is the objective marker independently associated with measured menstrual blood loss > 80 ml — it reflects the iron depletion caused by chronic heavy loss. (Passing large clots and flooding are also recognised predictors, but low ferritin is the objective laboratory one here.)",
        "A": "Incorrect. The validated clot threshold is > 1 inch (~2.5 cm), not ≥ 1 cm, so this option understates the size.",
    ...
    {
      "num": 20,
      "question": "Which of the following symptoms might suggest a hypothalamic or pituitary disorder in a patient with amenorrhea?",
      "options": [
        {
          "key": "A",
          "text": "Acne and hirsutism"
        },
        {
          "key": "B",
          "text": "Galactorrhea, headaches, or visual field defects"
        },
        {
          "key": "C",
          "text": "Menstrual periods lasting less than 2 days"
        },
        {
          "key": "D",
          "text": "Vasomotor symptoms like hot flashes or night sweats"
        }
      ],
      "correct": "B",
      "answerSource": "inferred",
      "explanations": {
        "B": "Correct. Galactorrhoea, headaches and visual field defects point to a pituitary lesion (e.g. a prolactinoma compressing the optic chiasm) as the cause of amenorrhoea.",
        "A": "Incorrect. Acne and hirsutism indicate hyperandrogenism (e.g. PCOS), an ovarian/adrenal problem.",
    ...
    {
      "num": 21,
      "question": "Which of the following non-pharmacologic therapies is supported by evidence for treating dysmenorrhea?",
      "options": [
        {
          "key": "A",
          "text": "High-frequency transcutaneous electrical nerve stimulation"
        },
        {
          "key": "B",
          "text": "Ice packs"
      ...
      "answerSource": "inferred",
      "explanations": {
        "A": "Correct. High-frequency TENS has the best evidence among non-pharmacological options for reducing primary dysmenorrhoea pain.",
        "B": "Incorrect. Local HEAT (not ice) helps dysmenorrhoea; ice packs are not supported.",
    ...
    {
      "num": 22,
      "question": "A 15 year old girl presents with primary amenorrhea and well developed breasts, but no pubic or axillary hair. Pelvic ultrasound shows no uterus. What is the most likely diagnosis?",
      "options": [
        {
          "key": "A",
        ...
        {
          "key": "C",
          "text": "Pure gonadal dysgenesis"
        },
        {
          "key": "D",
          "text": "Congenital adrenal syndrome"
        }
      ],
      "correct": "B",
      "answerSource": "inferred",
      "explanations": {
        "B": "Correct. Complete androgen insensitivity (46,XY) gives well-developed breasts (testosterone is aromatized to oestrogen), absent/scanty pubic and axillary hair (androgen receptors are non-functional), and an absent uterus (testicular anti-Müllerian hormone regressed the Müllerian ducts).",
        "A": "Incorrect. Turner syndrome (45,X) causes short stature and streak gonads with POOR breast development and a present (though often infantile) uterus.",
    ...
    {
      "num": 23,
      "question": "What is the correct sequence of pubertal events in girls?",
      "options": [
        {
          "key": "A",
          "text": "Thelarche, pubarche, growth spurt, menarche"
        },
        {
          "key": "B",
          "text": "Growth spurt, thelarche, menarche, pubarche"
        },
        {
          "key": "C",
          "text": "Thelarche, menarche, pubarche, growth spurt"
        },
        {
          "key": "D",
          "text": "Growth spurt, menarche, thelarche, pubarche"
        }
      ],
      "correct": "A",
      "answerSource": "inferred",
      "explanations": {
        "A": "Correct. In girls, puberty proceeds thelarche (breast budding) → pubarche (pubic hair) → peak growth spurt → menarche, which occurs late in the sequence.",
        "B": "Incorrect. The growth spurt does not come first in girls; thelarche is the first sign.",
    ...
    {
      "num": 24,
      "question": "A 21 year old primigravida at 36 weeks gestation presents to the emergency department complaining of severe headache and blurring of vision. On examination, there is lower limb oedema, BP: 160/110 and urine dipstick +3 for proteins. What is the most appropriate management for this patient?",
      "options": [
        {
          "key": "A",
          "text": "Methyl dopa and outpatient management"
        },
        {
          "key": "B",
          "text": "Hospital admission for bed rest, corticosteroids and observation"
        },
        {
          "key": "C",
          "text": "Hospital admission, antihypertensives and follow up till spontaneous labour"
        },
        {
          "key": "D",
          "text": "Admit to hospital, magnesium sulphate, antihypertensives and termination of pregnancy."
        }
      ],
      "correct": "D",
      "answerSource": "inferred",
      "explanations": {
        "D": "Correct. She has severe pre-eclampsia with neurological symptoms (severe headache, visual disturbance) at 36 weeks. Management is admission, magnesium sulphate for seizure prophylaxis, antihypertensives, and delivery — the definitive treatment at this gestation.",
        "A": "Incorrect. Severe pre-eclampsia with symptoms cannot be managed as an outpatient on methyldopa alone.",
    ...
    {
      "num": 25,
      "question": "Which of the following IV medications is used to treat respiratory depression that may accompany magnesium sulphate toxicity?",
      "options": [
        {
          "key": "A",
      ...
      "answerSource": "inferred",
      "explanations": {
        "A": "Correct. Calcium gluconate is the antidote to magnesium sulphate toxicity; calcium directly antagonises magnesium at the neuromuscular junction, reversing respiratory depression.",
        "B": "Incorrect. Epinephrine is for anaphylaxis/cardiac arrest, not magnesium toxicity.",
    ...
    {
      "num": 26,
      "question": "In a patient with severe preeclampsia, what is the main reason for visual symptoms and severe persistent headache?",
      "options": [
        {
          "key": "A",
          "text": "Partial embolic occlusion"
        },
        {
          "key": "B",
          "text": "Intense vasospasm"
        },
        {
          "key": "C",
      ...
      "answerSource": "inferred",
      "explanations": {
        "B": "Correct. The cerebral and retinal manifestations of severe pre-eclampsia are driven by intense arteriolar vasospasm (with endothelial dysfunction and vasogenic oedema), producing headache and visual disturbance.",
        "A": "Incorrect. Embolic occlusion is not the mechanism of pre-eclamptic visual/headache symptoms.",
    ...
    {
      "num": 27,
      "question": "A pregnant woman at 34 weeks' gestation develops marked pruritis especially on her palms and soles, with mildly increased liver enzymes and elevated bile acids. Which of the following diagnostic possibilities is consistent with this clinical picture?",
      "options": [
        {
          "key": "A",
          "text": "Pancreatitis"
        ...
        {
          "key": "B",
          "text": "Intrahepatic cholestasis of pregnancy"
        },
        {
          "key": "C",
          "text": "Acute fatty liver"
        },
        {
          "key": "D",
      ...
      "answerSource": "inferred",
      "explanations": {
        "B": "Correct. Pruritus of the palms and soles without a rash, with raised bile acids and mildly deranged transaminases in the third trimester, is the classic picture of intrahepatic cholestasis of pregnancy.",
        "A": "Incorrect. Pancreatitis presents with epigastric pain and very high amylase/lipase, not isolated pruritus.",
    ...
    {
      "num": 28,
      "question": "A 32 year old primigravida is admitted in spontaneous labour at 39 weeks gestation. She is a known asthmatic and had repeated admissions with acute exacerbations. The last admission was at 36 weeks where she was commenced on oral prednisolone 7.5 mg/day in view of the poor asthmatic control. Which of the following is the most appropriate intervention to maintain asthma control during labour?",
      "options": [
        {
          "key": "A",
          "text": "Continuous oxygen by face mask"
        },
        {
          "key": "B",
          "text": "Refer to respiratory physician"
        },
        {
          "key": "C",
          "text": "Regular inhaled long acting β2 agonist along with her current medications"
        },
        {
          "key": "D",
          "text": "100 mg parenteral hydrocortisone 6–8 hourly during labour."
        }
      ],
      "correct": "D",
      "answerSource": "inferred",
      "explanations": {
        "D": "Correct. A woman on ≥ 7.5 mg/day of oral prednisolone for over two weeks has hypothalamic–pituitary–adrenal suppression and needs parenteral hydrocortisone (e.g. 100 mg 6–8 hourly) to cover the stress of labour and prevent an adrenal crisis.",
        "A": "Incorrect. Oxygen is given only if she is hypoxic; it does not maintain asthma control or cover steroid dependence.",
    ...
    {
      "num": 29,
      "question": "Which of the following statements is INCORRECT regarding acute fatty liver of pregnancy?",
      "options": [
        {
          "key": "A",
          "text": "It is a fatal disease if not timely treated."
        },
        {
          "key": "B",
          "text": "May be complicated by disseminated intravascular coagulopathy"
        },
        {
          "key": "C",
          "text": "Blood glucose levels are elevated."
        },
        {
          "key": "D",
          "text": "May progress to fulminant hepatic failure rapidly."
        }
      ],
      "correct": "C",
      "answerSource": "inferred",
      "explanations": {
        "C": "Correct. This is the incorrect statement. Acute fatty liver of pregnancy characteristically causes HYPOglycaemia (from hepatic failure), not elevated blood glucose.",
        "A": "Incorrect. True — AFLP is fatal if not promptly recognised and delivered.",
    ...
    {
      "num": 30,
      "question": "What is the most common route of intrauterine infection leading to preterm labour?",
      "options": [
        {
          "key": "A",
          "text": "Haematogenous spread"
        },
        {
          "key": "B",
          "text": "Ascending infection from the vagina"
        },
        {
          "key": "C",
          "text": "Iatrogenic introduction of infection during procedures"
        },
        {
          "key": "D",
          "text": "Trans-placental spread."
        }
      ],
      "correct": "B",
      "answerSource": "inferred",
      "explanations": {
        "B": "Correct. Ascending infection from the lower genital tract through the cervix is by far the most common route of intra-amniotic infection triggering preterm labour.",
        "A": "Incorrect. Haematogenous (blood-borne) spread is a much less common route.",
    ...
    {
      "num": 31,
      "question": "A 30 year old woman at 32 weeks gestation presents with signs of preterm labour. What is the most appropriate next step to promote fetal lung maturity?",
      "options": [
        {
          "key": "A",
        ...
        {
          "key": "C",
          "text": "Administer corticosteroids"
        },
        {
          "key": "D",
          "text": "Begin magnesium sulphate for neuroprotection"
        }
      ],
      "correct": "C",
      "answerSource": "inferred",
      "explanations": {
        "C": "Correct. Antenatal corticosteroids (betamethasone/dexamethasone) accelerate fetal surfactant production and lung maturation and are the intervention that reduces respiratory distress syndrome.",
        "A": "Incorrect. Antibiotics treat infection (e.g. after ruptured membranes) but do not mature the lungs.",
    ...
    {
      "num": 32,
      "question": "Which of the following is a calcium channel blocker commonly used as a tocolytic agent?",
      "options": [
        {
          "key": "A",
          "text": "Indomethacin"
      ...
      "answerSource": "inferred",
      "explanations": {
        "B": "Correct. Nifedipine is a calcium channel blocker widely used as a tocolytic to suppress preterm uterine contractions.",
        "A": "Incorrect. Indomethacin is a prostaglandin synthetase inhibitor (NSAID) tocolytic, not a calcium channel blocker.",
    ...
    {
      "num": 33,
      "question": "Which of the following is the most appropriate mode of delivery in an uncomplicated dichorionic diamniotic twin pregnancy where the first twin is breech at 37 weeks?",
      "options": [
        {
          "key": "A",
          "text": "Vaginal breech delivery."
        },
        {
          "key": "B",
          "text": "Wait for spontaneous labour."
        },
        {
          "key": "C",
      ...
      "answerSource": "inferred",
      "explanations": {
        "C": "Correct. When the presenting (first) twin is non-cephalic/breech, elective caesarean section is recommended because of the risk of interlocking and cord complications with vaginal delivery.",
        "A": "Incorrect. Vaginal breech delivery of a leading twin is not recommended due to the risk of locked twins.",
    ...
    {
      "num": 34,
      "question": "How frequent should ultrasound be performed in monochorionic diamniotic pregnancies after 16 weeks of gestation?",
      "options": [
        {
          "key": "A",
          "text": "Every 4 weeks"
      ...
      "answerSource": "inferred",
      "explanations": {
        "B": "Correct. Monochorionic diamniotic twins are scanned every 2 weeks from 16 weeks to detect twin-to-twin transfusion syndrome and growth discordance early.",
        "A": "Incorrect. Every 4 weeks is the schedule for DICHORIONIC twins, which are lower risk.",
    ...
    {
      "num": 35,
      "question": "Which of the following cardiac conditions poses a significant health risk during pregnancy?",
      "options": [
        {
          "key": "A",
        ...
        {
          "key": "C",
          "text": "History of peripartum cardiomyopathy."
        },
        {
          "key": "D",
      ...
      "answerSource": "inferred",
      "explanations": {
        "C": "Correct. A history of peripartum cardiomyopathy carries a high risk of recurrence and maternal mortality in a subsequent pregnancy, making it the condition of greatest concern here.",
        "A": "Incorrect. Mitral valve prolapse is usually well tolerated in pregnancy.",
    ...
    {
      "num": 36,
      "question": "Mrs. (S) is a 32-year-old G3P2 woman who presents at 32 weeks gestation with swelling of the right leg. On examination, the right calf is markedly swollen, tender, and reddish. Her BMI is 31 kg/m2 and BP 110/65 mmHg. Which of the following is the best initial tool to exclude deep venous thrombosis (DVT)?",
      "options": [
        {
          "key": "A",
          "text": "D-Dimer level."
        ...
        {
          "key": "B",
          "text": "Compression venous Doppler."
        },
        {
          "key": "C",
          "text": "CT angiography."
      ...
      "answerSource": "inferred",
      "explanations": {
        "B": "Correct. Compression (Doppler) ultrasound of the leg veins is the first-line, safe, non-ionising investigation to diagnose or exclude DVT in pregnancy.",
        "A": "Incorrect. D-dimer is physiologically raised in pregnancy and is unreliable, so it is not used to exclude DVT.",
    ...
    {
      "num": 42,
      "question": "A 30 year old G3P2 woman presents at 32 weeks with painless bright red vaginal bleeding. The patient is vitally stable and bleeding is moderate in amount. Ultrasound confirms placenta previa. What is the best next step in management?",
      "options": [
        {
          "key": "A",
          "text": "Induce labour with oxytocin"
        },
        {
          "key": "B",
          "text": "Perform digital vaginal examination"
        },
        {
          "key": "C",
          "text": "Immediate caesarean section"
        ...
        {
          "key": "D",
          "text": "Admit for observation and fetal monitoring"
        }
      ],
      "correct": "D",
      "answerSource": "inferred",
      "explanations": {
        "D": "Correct. With confirmed placenta praevia, a stable mother, a preterm fetus (32 weeks) and settling moderate bleeding, the correct step is admission for observation and fetal monitoring (with steroids for lung maturity), aiming to prolong the pregnancy.",
        "A": "Incorrect. Inducing labour is contraindicated in placenta praevia — vaginal delivery risks catastrophic haemorrhage.",
    ...
    {
      "num": 43,
      "question": "A 30 year old primigravida at 39 weeks gestation presents in labour. On vaginal examination, the cervix is 7 cm dilated, 80% effaced and the fetal head is at -2 station. What does this most likely indicate?",
      "options": [
        {
          "key": "A",
          "text": "Latent phase of labour."
        },
        {
          "key": "B",
          "text": "Active phase of labour"
        },
        {
          "key": "C",
          "text": "Second stage of labour"
        },
        {
          "key": "D",
          "text": "Fetal head is engaged"
        }
      ],
      "correct": "B",
      "answerSource": "inferred",
      "explanations": {
        "B": "Correct. A cervix that is 7 cm dilated indicates the active (first-stage) phase of labour, which is defined from about 6 cm to full dilatation.",
        "A": "Incorrect. The latent phase is up to about 4–6 cm; 7 cm is beyond it.",
    ...
    {
      "num": 44,
      "question": "During normal vaginal delivery, after the head of the fetus is delivered, it rotates to realign with the shoulders inside the birth canal. What is this movement named?",
      "options": [
        {
          "key": "A",
          "text": "Flexion"
      ...
      "answerSource": "inferred",
      "explanations": {
        "D": "Correct. Restitution is the passive realignment of the delivered head with the shoulders (undoing the twist of internal rotation) after the head is born.",
        "A": "Incorrect. Flexion allows the smallest diameter of the head to present as it descends — it precedes delivery of the head.",
    ...
    {
      "num": 45,
      "question": "According to NICE guidelines on intrapartum care, which of the following is considered appropriate care for a woman in spontaneous labour?",
      "options": [
        {
          "key": "A",
          "text": "Routine perineal/pubic shaving prior to vaginal birth."
        },
        {
          "key": "B",
          "text": "Oral intake of fluids and light food is encouraged in uncomplicated labour."
        },
        {
          "key": "C",
          "text": "Administration of enema to reduce the need for labour augmentation."
        },
        {
          "key": "D",
          "text": "Vaginal examinations should be offered every 1 hour."
        }
      ],
      "correct": "B",
      "answerSource": "inferred",
      "explanations": {
        "B": "Correct. NICE supports allowing oral fluids and light diet in uncomplicated labour for low-risk women.",
        "A": "Incorrect. Routine perineal/pubic shaving is NOT recommended.",
    ...
    {
      "num": 46,
      "question": "Which of the following interventions is most effective in reducing perineal trauma during vaginal delivery?",
      "options": [
        {
          "key": "A",
          "text": "Warm perineal compresses and controlled delivery of the head."
        },
        {
          "key": "B",
          "text": "Routine episiotomy"
        },
        {
          "key": "C",
          "text": "Immediate pushing at full cervical dilatation"
        },
        {
          "key": "D",
      ...
      "answerSource": "inferred",
      "explanations": {
        "A": "Correct. Warm perineal compresses combined with controlled, slow delivery of the head reduce the risk of perineal tears and are evidence-based protective measures.",
        "B": "Incorrect. Routine (as opposed to selective) episiotomy increases, rather than reduces, perineal trauma.",
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "key": "D",
          "text": "Uterine fibroid (Leiomyoma)"
        }
      ],
      "correct": "C",
      "answerSource": "inferred",
      "explanations": {
        "C": "Correct. A uniformly enlarged, tender, globular uterus with a heterogeneous myometrium and small myometrial cysts on ultrasound, plus dysmenorrhoea and menorrhagia with a normal endometrial biopsy, is classic for adenomyosis.",
        "A": "Incorrect. Endometritis presents with infection/pelvic pain and tenderness but not a globular uterus with myometrial cysts.",
    ...
    {
      "num": 48,
      "question": "Which of the following is the most accepted theory for the pathogenesis of endometriosis?",
      "options": [
        {
          "key": "A",
          "text": "Sampson's theory of retrograde menstruation"
        },
        {
          "key": "B",
          "text": "Meyer's coelomic metaplasia theory"
        },
        {
          "key": "C",
          "text": "Genetic theory"
        ...
        {
          "key": "D",
          "text": "Lymphatic and vascular metastasis theory"
        }
      ],
      "correct": "A",
      "answerSource": "inferred",
      "explanations": {
        "A": "Correct. Sampson's theory of retrograde menstruation — viable endometrial cells refluxing through the tubes and implanting on peritoneal surfaces — is the most widely accepted explanation.",
        "B": "Incorrect. Coelomic metaplasia (Meyer) helps explain some sites but is less widely accepted as the primary mechanism.",
    ...
    {
      "num": 49,
      "question": "Which of the following is the preferred treatment for a woman with minimal to mild endometriosis who is trying to conceive?",
      "options": [
        {
          "key": "A",
          "text": "Laparoscopic ablation of endometriotic lesions"
        },
        {
          "key": "B",
          "text": "Progestins"
      ...
      "answerSource": "inferred",
      "explanations": {
        "A": "Correct. For a woman trying to conceive, laparoscopic ablation/excision of endometriotic lesions is preferred — it treats disease while preserving (and can improve) fertility.",
        "B": "Incorrect. Progestins suppress ovulation and act as contraceptives, so they are unsuitable for someone trying to conceive.",
    ...
    {
      "num": 50,
      "question": "A 23 year old woman, G1P0, presents at 8 weeks gestation with brownish discharge and mild pelvic discomfort. Transvaginal ultrasound shows a snowstorm pattern in the uterus consistent with complete mole and bilaterally enlarged multicystic ovaries containing clear fluid. What is the most likely type of the patient's ovarian cysts?",
      "options": [
        {
          "key": "A",
          "text": "Mucous cystadenoma"
        },
        {
          "key": "B",
          "text": "Endometrioma"
      ...
      "answerSource": "inferred",
      "explanations": {
        "D": "Correct. Bilaterally enlarged, multicystic ovaries in the setting of a molar pregnancy are theca-lutein cysts, driven by the very high β-hCG levels; they regress once the mole is evacuated.",
        "A": "Incorrect. A mucinous cystadenoma is a benign epithelial neoplasm unrelated to hCG and typically unilateral.",
    ...
    {
      "num": 51,
      "question": "What is the most serious complication that could occur on top of a corpus luteal cyst of the ovary?",
      "options": [
        {
          "key": "A",
        ...
        {
          "key": "C",
          "text": "Haemoperitoneum and acute abdomen"
        },
        {
          "key": "D",
      ...
      "answerSource": "inferred",
      "explanations": {
        "C": "Correct. Rupture of a corpus luteum cyst can cause significant intraperitoneal bleeding (haemoperitoneum) and an acute abdomen — potentially life-threatening and the most serious complication listed.",
        "A": "Incorrect. Torsion is a recognised complication but is generally less immediately life-threatening than major haemorrhage.",
    ...
    {
      "num": 52,
      "question": "A 41 year old woman presents to the gynaecology clinic with abdominal enlargement. She has a 7 cm solid ovarian tumour detected by ultrasound. Investigations performed showed right pleural effusion and a moderate amount of ascites. Which of the following is the most likely diagnosis?",
      "options": [
        {
          "key": "A",
          "text": "Ovarian teratoma"
        },
        {
          "key": "B",
        ...
        {
          "key": "D",
          "text": "Mucinous cyst adenoma"
        }
      ],
      "correct": "B",
      "answerSource": "inferred",
      "explanations": {
        "B": "Correct. The triad of a benign solid ovarian tumour (fibroma), ascites and a (classically right-sided) pleural effusion is Meigs' syndrome; the effusions resolve after the fibroma is removed.",
        "A": "Incorrect. A teratoma is a germ-cell tumour with mixed tissue elements and is not associated with Meigs' syndrome.",
    ...
    {
      "num": 53,
      "question": "Which of the following risks is associated with laparoscopic sterilization?",
      "options": [
        {
          "key": "A",
          "text": "Amenorrhea"
      ...
      "answerSource": "inferred",
      "explanations": {
        "C": "Correct. If sterilization fails and pregnancy occurs, the proportion that are ectopic is increased, so ectopic pregnancy is the recognised risk of tubal sterilization.",
        "A": "Incorrect. Sterilization does not affect ovarian hormone production, so it does not cause amenorrhoea.",
    ...
    {
      "num": 54,
      "question": "Which of the following methods can be used as emergency contraception?",
      "options": [
        {
          "key": "A",
        ...
        {
          "key": "B",
          "text": "Subcutaneous implants"
        },
        {
          "key": "C",
          "text": "Progesterone injectables"
        },
        {
          "key": "D",
      ...
      "answerSource": "inferred",
      "explanations": {
        "D": "Correct. The copper intrauterine device is the most effective emergency contraceptive, and can be inserted up to 5 days after unprotected intercourse (or after the estimated ovulation).",
        "A": "Incorrect. Standard progestogen-only pills are for ongoing contraception; the dedicated emergency pill is levonorgestrel or ulipristal, not the regular POP.",
    ...
    {
      "num": 55,
      "question": "Which of the following is an absolute contraindication to combined oral contraceptive use?",
      "options": [
        {
          "key": "A",
          "text": "Controlled hypertension"
        },
        {
          "key": "B",
          "text": "History of migraine with aura"
        },
        {
          "key": "C",
          "text": "Age over 40"
      ...
      "answerSource": "inferred",
      "explanations": {
        "B": "Correct. Migraine with aura is an absolute contraindication (UKMEC 4) to combined oral contraceptives because of the substantially increased risk of ischaemic stroke.",
        "A": "Incorrect. Well-controlled hypertension is a relative (UKMEC 3), not absolute, contraindication.",
    ...
    {
      "num": 56,
      "question": "A 23-year-old female presents with oligomenorrhea and abnormal facial hair growth along with high serum free testosterone level. On ultrasound, the ovaries appear normal. What is the most likely diagnosis?",
      "options": [
        {
          "key": "A",
          "text": "Idiopathic hirsutism"
        },
        {
          "key": "B",
        ...
        {
          "key": "C",
          "text": "Testosterone secreting tumor"
        },
        {
          "key": "D",
      ...
      "answerSource": "inferred",
      "explanations": {
        "B": "Correct. She meets the Rotterdam criteria with two of three features — oligomenorrhoea (anovulation) plus clinical and biochemical hyperandrogenism — so PCOS is diagnosed even when the ovaries look normal on ultrasound.",
        "A": "Incorrect. Idiopathic hirsutism occurs with REGULAR cycles and normal androgen levels; she has oligomenorrhoea and raised testosterone.",
    ...
    {
      "num": 57,
      "question": "What is the primary reason for irregular menstruation in women with polycystic ovarian syndrome (PCOS)?",
      "options": [
        {
          "key": "A",
          "text": "Failure of follicle maturation and anovulation"
        },
        {
          "key": "B",
          "text": "Hyperprolactinaemia"
        },
        {
          "key": "C",
          "text": "Low oestrogen levels"
        },
        {
          "key": "D",
          "text": "High progesterone levels"
        }
      ],
      "correct": "A",
      "answerSource": "inferred",
      "explanations": {
        "A": "Correct. In PCOS, follicles fail to mature and ovulate (chronic anovulation), so there is no cyclical progesterone withdrawal, giving irregular/absent menses.",
        "B": "Incorrect. Hyperprolactinaemia is a separate cause of menstrual disturbance, not the mechanism in PCOS.",
    ...
    {
      "num": 58,
      "question": "Which of the following is NOT a feature of polycystic ovarian syndrome (PCOS)?",
      "options": [
        {
          "key": "A",
          "text": "Elevated LH:FSH ratio"
        },
        {
          "key": "B",
          "text": "Decreased hepatic production of sex hormone binding globulin"
        },
        {
          "key": "C",
          "text": "Elevated AMH"
      ...
      "answerSource": "inferred",
      "explanations": {
        "D": "Correct. High progesterone is NOT a feature. Because PCOS is anovulatory, there is no corpus luteum and progesterone stays LOW.",
        "A": "Incorrect. True feature — the LH:FSH ratio is characteristically raised.",
    ...
    {
      "num": 59,
      "question": "What is the recommended first-line pharmacological treatment for premenstrual dysphoric disorder (PMDD)?",
      "options": [
        {
          "key": "A",
      ...
      "answerSource": "inferred",
      "explanations": {
        "C": "Correct. SSRIs are first-line pharmacological therapy for PMDD and can be given continuously or only in the luteal phase.",
        "A": "Incorrect. Combined oral contraceptives (especially drospirenone-containing) help some women but are not the first-line pharmacological treatment for the mood symptoms of PMDD.",
    ...
    {
      "num": 60,
      "question": "What distinguishes secondary vaginismus from primary vaginismus?",
      "options": [
        {
          "key": "A",
          "text": "Involuntary contractions occur only during menstruation"
        },
        {
          "key": "B",
          "text": "Caused solely by hormonal changes"
        },
        {
          "key": "C",
          "text": "Develops after a period of normal sexual function"
        },
        {
          "key": "D",
          "text": "Always associated with physical trauma"
        }
      ],
      "correct": "C",
      "answerSource": "inferred",
      "explanations": {
        "C": "Correct. Secondary vaginismus develops AFTER a period of previously normal, pain-free sexual function, whereas primary vaginismus has been present from the first attempt at penetration.",
        "A": "Incorrect. Vaginismus is not confined to menstruation.",
